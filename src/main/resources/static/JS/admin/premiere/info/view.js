...
function chkDelete(){
	if(!confirm("해당 글을 삭제 하시겠습니까?")) return false;
...
function writeData(jsonObj){
	...
	result += "<div id='title'>영화 제목 : " + jsonObj.title + "</div><br>\n"
	if(jsonObj.photo == "") {
		// 저장된 사진이 없다면 디폴트 이미지 보여주기
		result += "<div id='image'><img src='/file/premiere/no_img.png' alt='빈이미지'/></div><br>\n"
	} else {
		result += "<img src='/file/premiere/" + jsonObj.photo + "' id='image'/><br>\n"
	}
	result += "<div id='content'>내용 : " + jsonObj.content + "</div><br>\n"
